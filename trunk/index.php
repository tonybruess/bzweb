...
$authPage = 'http://my.bzflag.org/weblogin.php?url=' . urlencode('http://'.$_SERVER['SERVER_NAME'] . rtrim(dirname($_SERVER['SCRIPT_NAME']), '/') . '/authenticate.php?token=%TOKEN%&username=%USERNAME%');
